...
GRANT CONNECT ON DATABASE "datastore_default" TO "postgresro";
GRANT USAGE ON SCHEMA public TO "postgresro";

-- grant access to current tables and views to read-only user
GRANT SELECT ON ALL TABLES IN SCHEMA public TO "postgresro";

-- grant access to new tables and views by default
ALTER DEFAULT PRIVILEGES FOR USER "postgres" IN SCHEMA public
   GRANT SELECT ON TABLES TO "postgresro";
...
GRANT SELECT ON "_table_metadata" TO "postgresro";
